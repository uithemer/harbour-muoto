...
Dialog {
    ...
    readonly property bool dirty: pendingEnabled !== appliedEnabled || pendingFromPocket !== appliedFromPocket || pendingHover !== appliedHover || pendingProximityReady !== appliedProximityReady
    ...
    onAccepted: {
        ...
        if (MceLpm.apply(pendingEnabled, pendingFromPocket, hover, pendingProximityReady))
