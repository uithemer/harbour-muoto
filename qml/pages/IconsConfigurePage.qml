...
Dialog {
    ...
    readonly property bool hasIconOverlay: effectiveIndex >= 0 && packModel.hasIconOverlay(effectiveIndex)
    readonly property bool hasDynClock: stockSelected || (effectiveIndex >= 0 && packModel.hasDynClock(effectiveIndex))
    readonly property bool hasDynCalendar: stockSelected || (effectiveIndex >= 0 && packModel.hasDynCalendar(effectiveIndex))
