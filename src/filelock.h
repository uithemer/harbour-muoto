...
//   - GUI applyIcons/restoreIcons/reassertCurrentTheme/refreshOriginals
//   - sailfishos-uithemer-reassert helper invocations
//   - themepacksupport-systemupgrade.service
//
